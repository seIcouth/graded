...
class ForgotPasswordScreen extends StatefulWidget {
  const ForgotPasswordScreen({Key? key, this.currentPassword}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: IconButton(
                            ...
                            icon: Icon(Icons.arrow_back_ios, color: ReusableMethods.colorDark,),
                          ),
                        ),
                      ),
                      SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    if (_emailController.text.isEmpty) {
                                      ...
                                      if (ReusableMethods.isValidEmail(_emailController.text)) {
                                        try {
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    }else if(widget.currentPassword != _currentPasswordController.text){
                                      Flushbar(
